/* Oecophylla — fictional content fixtures (Vietnamese).
   All authors, posts, groups, comments are invented for design purposes. */
const TOPICS = [
...
const NOTIFICATIONS = [
  { id: 'n1', kind: 'interact', icon: 'HeartFill', tone: 'rose', unread: true, who: AUTHORS[3],
    msg: <><b>Phạm Hữu Long</b> và 12 người khác đã thích bài <b>“Vì sao các mô hình ngôn ngữ Việt Nam vẫn lệch…”</b></>,
    time: '12 phút trước', cat: 'Tương tác' },
  { id: 'n2', kind: 'system', icon: 'Shield', tone: 'emerald', unread: true, who: null,
    msg: <>Bài viết của bạn <b>“Tự host một mô hình 8B trên Mac Mini M4”</b> đã được kiểm duyệt và xuất bản công khai.</>,
    time: '1 giờ trước', cat: 'Kiểm duyệt' },
  { id: 'n3', kind: 'follow', icon: 'User', tone: 'azure', unread: true, who: AUTHORS[7],
    msg: <><b>Vũ Thái Sơn</b> đã bắt đầu theo dõi bạn.</>,
    time: '3 giờ trước', cat: 'Tương tác' },
  { id: 'n4', kind: 'comment', icon: 'Comment', tone: 'azure', unread: false, who: AUTHORS[5],
    msg: <><b>Bùi Khánh Linh</b> đã bình luận về bài <b>“Quy định mới về dán nhãn nội dung AI”</b>: “Bài phân tích cân bằng và rõ ràng…”</>,
    time: 'Hôm qua', cat: 'Tương tác' },
  { id: 'n5', kind: 'suggest', icon: 'Sparkle', tone: 'violet', unread: false, who: null,
    msg: <>Có <b>3 chủ đề mới</b> phù hợp với bạn: <em>An toàn thông tin</em>, <em>Edge AI</em>, <em>Năng lượng tái tạo</em>.</>,
    time: 'Hôm qua', cat: 'Gợi ý' },
  { id: 'n6', kind: 'moderation', icon: 'AlertCircle', tone: 'amber', unread: false, who: null,
    msg: <>Bình luận của bạn trong bài <b>“Lãi suất chính sách giữ nguyên”</b> được yêu cầu chỉnh sửa nhẹ trước khi đăng công khai.</>,
    time: '2 ngày trước', cat: 'Kiểm duyệt' },
];

window.DATA = { TOPICS, AUTHORS, POSTS, TRENDING, SUGGEST_FOLLOW, TASTE, NOTIFICATIONS };
