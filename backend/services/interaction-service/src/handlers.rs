...
pub async fn save_post(State(s): State<AppState>, Path(id): Path<Uuid>, h: HeaderMap) -> AppResult<impl IntoResponse> {
    toggle_post(s, h, id, "save", "POST").await
}
pub async fn unsave_post(State(s): State<AppState>, Path(id): Path<Uuid>, h: HeaderMap) -> AppResult<impl IntoResponse> {
    toggle_post(s, h, id, "save", "DELETE").await
}
pub async fn share_post(State(s): State<AppState>, Path(id): Path<Uuid>, h: HeaderMap) -> AppResult<impl IntoResponse> {
    toggle_post(s, h, id, "share", "POST").await
}
pub async fn unshare_post(State(s): State<AppState>, Path(id): Path<Uuid>, h: HeaderMap) -> AppResult<impl IntoResponse> {
    toggle_post(s, h, id, "share", "DELETE").await
}
pub async fn hide_post(State(s): State<AppState>, Path(id): Path<Uuid>, h: HeaderMap) -> AppResult<impl IntoResponse> {
    toggle_post(s, h, id, "hide", "POST").await
}
pub async fn unhide_post(State(s): State<AppState>, Path(id): Path<Uuid>, h: HeaderMap) -> AppResult<impl IntoResponse> {
